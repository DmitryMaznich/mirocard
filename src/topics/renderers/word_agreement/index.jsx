...
// case_agreement, verb_number, verb_gender and numeral_agreement are all
// plain "sentence with a blank, pick the matching word form" tasks — same
// component, the difference is entirely in the card data.
const FILL_BLANK_TYPES = new Set(["case_agreement", "verb_number", "verb_gender", "numeral_agreement"]);
