    ...
    },
    {
      ...
      params: {
        ...
        numericBlocks: {
          ...
          default: false,
          offLabel: { ru: "Десятки" },
          label: { ru: "Блоки с цифрами" },
          section: "Отображение",
          info: {
            ru: {
              text: "Переключает вид блоков: кубики-единицы и палочки-десятки («Десятки») или блоки с написанными на них цифрами.",
              tip: "«Десятки» ближе к реальному счёту предметов — используйте цифровые блоки только как промежуточный шаг.",
            },
          },
        },
      },
