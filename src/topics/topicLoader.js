    ...
    },
    {
      ...
      params: {
        ...
        digits: {
          type: "enum",
          values: [2, 3, "2+1"],
          labels: { ru: { "2": "2-зн.", "3": "3-зн.", "2+1": "2-зн. + 1-зн." } },
          default: 2,
          label: { ru: "Разрядность" },
          section: "Что решаем",
          info: {
            ru: {
              text: "Сколько цифр в числах примера — двузначные (например, 34+18), трёхзначные (246+137) или «2-зн. + 1-зн.» — двузначное и однозначное число вместе (например, 34+7), где у нижнего числа просто нет разряда десятков.",
              tip: "«2-зн. + 1-зн.» — отдельная трудность: ребёнок должен понять, что однозначное число встаёт под разряд единиц, а не пишет 0 в десятках. Переходите на 3-значные только когда 2-значные примеры с переносом/займом решаются уверенно.",
            },
          },
        },
        showHelper: {
    ...
    },
    {
      ...
      params: {
        ...
        digits: {
          ...
          info: {
            ru: {
              text: "Сколько цифр в числах примера — двузначные, трёхзначные или «2-зн. + 1-зн.» (двузначное и однозначное число вместе, например 34+7).",
