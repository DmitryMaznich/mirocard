...
const DEFAULT_MODE_METHODOLOGY = {
  ...
  addition_subtraction: {
    operation_observe: {
      summary: "Наблюдение за изменением количества: стало больше или меньше.",
      text: "Ребёнок сначала смотрит, как меняется группа предметов, затем выбирает направление изменения — «больше» или «меньше». В этом режиме ещё нет знаков и не нужно называть действие.",
      settings: ["Начинайте с диапазона до 3 без цифр.", "Цифры включайте только как дополнительную опору, а не вместо предметов."],
      goal: "Ребёнок замечает, что количество стало больше или меньше, и выбирает это направление по наблюдаемой ситуации.",
    },
