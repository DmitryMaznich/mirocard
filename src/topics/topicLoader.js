    ...
    },
    {
      ...
      params: {
        ...
        digits: {
          ...
          info: {
            ru: {
              text: "Сколько цифр в числах примера — двузначные (например, 34+18), трёхзначные (246+137), «2-зн. + 1-зн.» — двузначное и однозначное число вместе (например, 34+7), где у нижнего числа просто нет разряда десятков, — или «Круглые дес.» — оба числа кратны 10 (10+20, 60+70).",
              tip: "«2-зн. + 1-зн.» — отдельная трудность: ребёнок должен понять, что однозначное число встаёт под разряд единиц, а не пишет 0 в десятках. «Круглые дес.» — тоже отдельный шаг: считать десятками как единицами (6+7=13 → 60+70=130), без внимания к нулям в конце. Переходите на 3-значные только когда 2-значные примеры с переносом/займом решаются уверенно.",
            },
          },
        },
        showHelper: {
