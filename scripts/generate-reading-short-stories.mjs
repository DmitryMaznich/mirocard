  ...
  texts: [
    {
      ...
      lines: makeLines([
        ...
        ["l4", "Ва-ня ска-зал:", { newParagraph: true }],
        ["l5", "— Дай мяч мне."],
        ["l6", "Ми-ша ска-зал:"],
        ["l7", "— Нет, дай мяч мне."],
        ...
        ["l11", "Сна-ча-ла Ва-ня ка-тил мяч.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l5", "На шум при-шла ма-ма.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l5", "Ма-ма ска-за-ла:", { newParagraph: true }],
        ["l6", "— Вспом-ни, где ты её снял."],
        ["l7", "И-горь вер-нул-ся к ска-мей-ке.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l4", "Ма-ша на-сы-па-ла в неё зёр-на.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l5", "Ли-за дер-жа-ла зонт над щен-ком, по-ка не за-кон-чил-ся дождь.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l6", "Ба-буш-ка ска-за-ла:", { newParagraph: true }],
        ["l7", "— Спа-си-бо, Де-нис."],
        ["l8", "Де-нис бу-дет уха-жи-вать за цве-тком."],
      ]),
    },
    {
      id: "hedgehog",
      ...
      lines: makeLines([
        ...
        ["l4", "Ба-буш-ка ска-за-ла:", { newParagraph: true }],
        ["l5", "— Не тро-гай е-жа. Е-му луч-ше жить в са-ду."],
        ["l6", "Ка-тя по-ста-ви-ла ря-дом ми-ску с во-дой.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l4", "На-дя ска-за-ла:", { newParagraph: true }],
        ["l5", "— Да-вай у-бе-рём иг-руш-ки."],
        ["l6", "Де-ти по-ло-жи-ли ку-би-ки в я-щик.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l3", "Пе-тя дал ей свой крас-ный ка-ран-даш.", { newParagraph: true }],
    ...
    },
    {
      ...
      lines: makeLines([
        ...
        ["l4", "Се-рё-жа ос-та-но-вил-ся.", { newParagraph: true }],
        ["l5", "Он про-пус-тил ба-буш-ку."],
        ["l6", "Ба-буш-ка ска-за-ла:"],
        ["l7", "— Спа-си-бо, Се-рё-жа."],
        ["l8", "Се-рё-жа по-е-хал даль-ше."],
      ]),
    },
    {
      id: "cookies",
      ...
      lines: makeLines([
        ...
        ["l4", "О-ни по-ло-жи-ли пе-чень-е на про-ти-вень.", { newParagraph: true }],
