...
const manifest = {
  ...
  texts: [
    ...
    },
    {
      ...
      level: 1,
      lines: makeLines([
        ["l1", "У Те-мы и Кос-ти бы-ла од-на ло-шад-ка на ко-лё-си-ках."],
        ["l2", "Тё-ма хо-тел по-ка-тать е-ё пер-вым."],
        ["l3", "Кос-тя то-же хо-тел по-ка-тать е-ё пер-вым."],
        ["l4", "Маль-чи-ки схва-ти-ли ло-шад-ку и ста-ли тя-нуть каж-дый к се-бе."],
        ["l5", "На шум при-шла ма-ма."],
        ["l6", "— Ес-ли не мо-же-те иг-рать вме-сте, ло-шад-ка по-ка по-жи-вёт на пол-ке, — ска-за-ла ма-ма."],
      ...
      questions: [
        ...
        },
        {
          ...
          answer: ["забрала лошадку", "убрала лошадку на полку"],
