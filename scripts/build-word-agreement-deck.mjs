...
const entry = {
  ...
  title:    { ru: "Языковой тренажёр" },
  description: {
    ru: "Согласование слов и окончаний в предложениях. Падеж существительного (мяч, карандаш, машина, яблоко) и число глагола. Настраиваемая сложность: от двух до шести вариантов ответа.",
  },
  renderer: "word_agreement",
  status:   "release",
  access:   "free",
