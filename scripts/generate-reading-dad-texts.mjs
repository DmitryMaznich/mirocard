...
const manifest = {
  ...
  texts: [
    ...
    },
    {
      ...
      steps: [
        { id: "s1",  type: "action",    text: "Вымой руки." },
        { id: "s2",  type: "checklist", text: "Достань нужную посуду:", items: ["кастрюлю", "нож", "доску", "толкушку", "дуршлаг", "ложку", "тарелку"] },
        ...
        { id: "s5",  type: "action",    text: "Почисти картошку ножом на доске." },
...
writeFileSync("public/decks/reading_dad_texts_v1.8.0.zip", buffer);
