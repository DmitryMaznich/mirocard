/**
 * Generates photos and audio for word_formation_juice deck.
 * Output: public/decks/word_formation_juice_v1.0.0.zip
 */
...
const CACHE_DIR = path.join(ROOT, ".cache", "word_formation_juice");

const TOPIC_ID  = "word_formation_juice";
const VERSION   = "1.0.0";
...
const QUESTION_TEXT  = "Какой сок получится?";
const VESSEL_IMAGE   = "media/juicer.webp";
...
const CONCEPTS = [
  { id: "yabloko",  noun: "яблоко",   nounPhrase: "сок из яблок",       adjPhrase: "яблочный сок",      difficulty: "easy",   color: "#8BC34A",
  ...
  { id: "morkov",   noun: "морковь",  nounPhrase: "сок из моркови",      adjPhrase: "морковный сок",     difficulty: "easy",   color: "#FF9800",
  ...
  { id: "vinograd", noun: "виноград", nounPhrase: "сок из винограда",    adjPhrase: "виноградный сок",   difficulty: "medium", color: "#9C27B0",
  ...
  { id: "apelsin",  noun: "апельсин", nounPhrase: "сок из апельсинов",   adjPhrase: "апельсиновый сок",  difficulty: "medium", color: "#FF5722",
  ...
  { id: "vishnya",  noun: "вишня",    nounPhrase: "сок из вишни",        adjPhrase: "вишнёвый сок",      difficulty: "hard",   color: "#E91E63",
...
function buildTopic() {
  ...
  return {
    meta: {
      ...
      title: { ru: "Сок: словообразование", en: "Juice: word formation" }, language: "ru",
      vesselImage:   VESSEL_IMAGE,
    ...
    modes: [
      { id: "pair_intro",   type: "pair_intro",   evaluation: "none", requirePin: false,
        ui: { title: { ru: "Знакомство с парами" }, instruction: { ru: "Листайте пары: сок из … → … сок" } } },
      ...
      { id: "question_ask", type: "question_ask", evaluation: "none", requirePin: true,
        ui: { title: { ru: "Назови сок" }, instruction: { ru: "Логопед задаёт вопрос устно" } },
      },
    ],
    cards,
  };
...
async function main() {
  ...
  const juicerImage = await generateImageFromPrompt("juicer.webp", JUICER_PROMPT, "juicer");
  const resultImages = {};
  ...
  zip.file(VESSEL_IMAGE, juicerImage);
  ...
  catalog.decks.push({
    ...
    title: { ru: "Сок: словообразование", en: "Juice: word formation" },
