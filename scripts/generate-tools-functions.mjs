...
const CONCEPTS = [
  ...
  },
  {
    ...
    action: "чистят стены и намазывают шпаклёвку",
    actionInf: "чистить стены и намазывать шпаклёвку",
    ...
    modes: [
      ...
      },
      {
        ...
        methodology: {
          ...
          goal: "Ребёнок самостоятельно называет все 12 инструментов по фотографии без подсказок.",
          tips: [
      ...
      },
      {
        ...
        methodology: {
          ...
          goal: "Ребёнок безошибочно находит любой инструмент из 12 среди 4 вариантов по названию.",
          tips: [
      ...
      },
      {
        ...
        methodology: {
          ...
          goal: "Ребёнок уверенно различает верные и неверные подписи для всех 12 инструментов.",
          tips: [
      ...
      },
      {
        ...
        methodology: {
          ...
          goal: "Ребёнок правильно выбирает письменное название для каждого инструмента без подсказок.",
          tips: [
      ...
      },
      {
        ...
        methodology: {
          ...
          goal: "Ребёнок находит все нужные инструменты в сетке без лишних нажатий и без подсказок.",
          tips: [
      ...
      },
      {
        ...
        methodology: {
          ...
          goal: "Ребёнок правильно называет применение каждого из 12 инструментов без подсказок.",
          tips: [
      ...
      },
      {
        ...
        methodology: {
          ...
          goal: "Ребёнок определяет нужный инструмент по сцене задачи для всех 12 понятий без подсказок.",
          tips: [
